...
QUESTION = r"""
Consider the projective space \(\mathbb{P}^5\) over an algebraically closed field of characteristic 0, with homogeneous coordinates \([z_0:\dots:z_5]\). Let \(Q_1,Q_2,Q_3\) 
be three generic homogeneous quadratic polynomials and \(C_1,C_2\) be two generic homogeneous cubic polynomials in these variables. Define the zero‑dimensional scheme
